#!/usr/bin/env perl
my $USAGE = "Usage: $0 [--inifile Xref2var.ini] [--section Xref2Var]  [--recmark lx] [--eolrep #] [--reptag __hash__] [--v2cfini PromoteSubentries.ini] [--v2cfsctn Var2Compform] [--debug] [file.sfm]";
=pod
...
GetOptions (
	...
	'v2cfini:s' =>  \(my $v2cfini = "PromoteSubentries.ini"), # Control file to get Compform tag(s)
	'v2cfsctn:s' =>  \(my $v2cfsctn = "Var2Compform"), # section of Control file to get Compform tag(s)
	'debug'       => \my $debug,
	) or die $USAGE;
...
my $defaultcompformtype = '_UNSPECIFIED_';

# get default compform tag
